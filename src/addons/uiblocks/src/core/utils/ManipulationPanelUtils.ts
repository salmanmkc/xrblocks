 ...
 */
export function createManipulationUniforms(): ShaderUniforms {
  return {
 ...
 */
export function updateManipulationUniforms(
  ...
  if (properties.u_manipulation_edge_color !== undefined) {
    ...
    if (u) {
      const {color, opacity} = parseColorWithAlpha(
        properties.u_manipulation_edge_color
      );
  ...
  if (properties.u_cursor_spotlight_color !== undefined) {
    ...
    if (u) {
      const {color, opacity} = parseColorWithAlpha(
        properties.u_cursor_spotlight_color
      );
      u.value.set(color.r, color.g, color.b, opacity);
    }
  }
  ...
  if (properties.u_show_glow !== undefined) {
    ...
    if (u) u.value = properties.u_show_glow;
  }
  ...
  if (properties.u_show_glow_2 !== undefined) {
    ...
    if (u) u.value = properties.u_show_glow_2;
  }
}

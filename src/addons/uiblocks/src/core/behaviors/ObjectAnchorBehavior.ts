 ...
 */
export class ObjectAnchorBehavior extends UICardBehavior<ObjectAnchorConfig> {
  ...
  constructor(config: ObjectAnchorConfig) {
    ...
    if (config.positionOffset) this.positionOffset.copy(config.positionOffset);
    if (config.rotationOffset) this.rotationOffset.copy(config.rotationOffset);
  }
